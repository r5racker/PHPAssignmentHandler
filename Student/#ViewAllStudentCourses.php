...
if(isset($_SESSION['user_email'])){
  ...
  <table class="table table-hover table-light">
    ...
    <tbody>
     <?php while($ret_row1=$ret_prepared_sql->fetch())
    {
        $ret_sql2="select assign_id,assign_name,initial_date,due_date,max_size from Assignments where c_id=?";
        $ret_prepared_sql2=$dbhandler->prepare($ret_sql2);
        $ret_prepared_sql2->execute(array($ret_row1['c_id']));
