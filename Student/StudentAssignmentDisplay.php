...
?>  
      <tr>
        ...
        <td><a href="ViewSubmittedFile.php?semail=<?php echo $_GET['email']; ?>&asid=<?php echo $ret_row['assign_id']; ?>&foldername=<?php echo $ret_row['student_email']; ?>&filename=<?php echo $ret_row['submission_file_name']; ?>">View File</a></td>
      </tr>
    <?php }
}?>      
    </tbody>
