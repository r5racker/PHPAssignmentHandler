    ...
    if(/*empty($_POST['username'])||strlen($_POST['username'])>11*/0){
        ...
        if(empty ($_FILES["teacher_image"]["name"]))
        {
            ...
            if($row["teacher_email"]==$teacher_email){
                header('Location:../login.php?message=you are already registered&user_email='.$_POST["teacher_email"]);
            }
            ...
            else
            {
                ...
                try{
                    ...
                    $prepared_sql2->execute(array($_POST["teacher_email"],$_POST["teacher_password"],"tech"));
                    echo "Data is inserted successfully";

                    session_start();
                    $_SESSION['user_email']=$_POST["teacher_email"];
                    echo "successfully registered";
                    header('Location:../Teacher/TeacherHome.php?user_email='.$_POST["teacher_email"]);
                }
