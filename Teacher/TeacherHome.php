...
if(isset($_SESSION['user_email'])){
    ...
    $ret_sql="select assign_id,assign_name,c_id from Assignments where teacher_email=?";
...
?>  
    ...
    <td><a class="btn btn-outline-primary" href="AssignmentPage.php" role="button">Add Assignment</a></td></tr>
