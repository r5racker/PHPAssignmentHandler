...
if(isset($_SESSION['user_email'])){
    ...
    $ret_sql="select * from Submissions where student_email=?" ;
    $ret_prepared_sql=$dbhandler->prepare($ret_sql);
    $ret_prepared_sql->execute(array($_GET["email"]));
?>
<div class="container table-responsive">
  <h2>Submission List</h2>
  <div class="col-3">
      <h3>Click Here to see Student Profile.</h3>
	<a class="btn btn-success" href="StudentProfile.php?user_email=<?php echo $_GET["email"];?>" role="button">
		Profile
	</a>
</div>
...
?>  
      <tr>
        ...
        <td><a href="ViewFile.php?semail=<?php echo $_GET['email']; ?>&asid=<?php echo $ret_row['assign_id']; ?>&foldername=<?php echo $ret_row['student_email']; ?>&filename=<?php echo $ret_row['submission_file_name']; ?>">View File</a></td>
      </tr>
    <?php }
}?>      
    </tbody>
