...
<html lang="en">
  ...
  <body style="background-color:powderblue;">
      ...
      //echo ' '.$_SERVER["REQUEST_METHOD"];
                              //echo 'php:'.$_POST["user_email"]." ".$_POST["user_password"];
if(isset($_POST["user_email"])&&isset($_POST["user_password"])){
	...
	if(strcmp($_POST["user_email"],$row["user_email"])==0&&strcmp($_POST["user_password"],$row["user_password"])==0){
		...
		if(strcmp($row["user_type"],'stu')==0){
			...
			header('Location:Teacher/TeacherHome.php?user_email='.$_POST["student_email"]);
		}
	}
	else{
...
<center>
  ...
  <br><strong>Forgot Password???....<a href="PasswordReset/ForgotPassword.html">Reset password</a></strong>
  </form>
</center>
